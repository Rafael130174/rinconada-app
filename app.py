...
def generar_codigo_ticket():
  """Genera un código único alfanumérico corto ej: RINC-A4K9"""
...
def vender():
  ...
  # Generar código único de ticket asegurando que no se repita
  while True:
...
def escrutar():
  ...
  # Borra los boletos actuales (limpia la tabla para el día siguiente)
  Boleto.query.delete()
  db.session.commit()
