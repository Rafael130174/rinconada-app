...
<body>
    <div class="login-card">
        ...
        <p style="font-size: 13px; color: #666;">Ingreso al Sistema</p>
...
<body>
    <div class="header-app">
        ...
        <p>Sistema Control de Jugadas</p>
    </div>
    ...
    <div class="card" style="border: 2px solid #d93025;">
        ...
        <form method="POST" action="/escrutar">
            <p style="font-size: 13px; color: #666; text-align: center;">Ingresa los 6 animalitos premiados:</p>
            {% for i, hora in validas %}
        ...
        <div class="reporte-box">
            <h4 style="margin: 0 0 10px 0; text-align:center;">📊 Balance General de la Jornada</h4>
        ...
        <h4 style="margin-top: 15px; margin-bottom: 5px;">📋 Lista de Ganadores</h4>
        {% if ganadores %}
            {% for g in ganadores %}
            <div class="winner">
            ...
            {% endfor %}
        {% else %}
            <p style="text-align: center; color: #d93025; font-weight: bold; font-size: 14px;">❌ No hubo tickets ganadores. ¡El pozo pasa al acumulado!</p>
        {% endif %}
        {% endif %}
    </div>
...
def home():
    ...
    return render_template_string(MAIN_HTML, animalitos=ANIMALITOS, validas=validas_list, acum=acum, historial=historial)
...
✅ Ticket Registrado."""
    ...
    return render_template_string(MAIN_HTML, animalitos=ANIMALITOS, validas=validas_list, ticket=ticket_res, acum=acum, historial=historial)
...
def escrutar():
    ...
    for b in boletos:
        ...
        if aciertos == 6:
            cant_6 += 1
            ganadores.append({"cliente": b.cliente, "telefono": b.telefono, "loteria": b.loteria, "tipo": "🥇 Primer Premio (6 Aciertos)"})
        elif aciertos == 5:
            cant_5 += 1
            ganadores.append({"cliente": b.cliente, "telefono": b.telefono, "loteria": b.loteria, "tipo": "🥈 Segundo Premio (5 Aciertos)"})
        elif aciertos == 4:
            cant_4 += 1
            ganadores.append({"cliente": b.cliente, "telefono": b.telefono, "loteria": b.loteria, "tipo": "🥉 Tercer Premio (4 Aciertos)"})
            
        if b.pote_3 == resultados['3'] and b.pote_6 == resultados['6']:
            cant_pote += 1
            ganadores.append({"cliente": b.cliente, "telefono": b.telefono, "loteria": b.loteria, "tipo": "🔥 Pote Fijo"})
    ...
    historial = Historial.query.order_by(Historial.id.desc()).all()
    return render_template_string(MAIN_HTML, animalitos=ANIMALITOS, validas=validas_list, financiero=financiero, ganadores=ganadores, acum=acum_anterior, historial=historial)
