...
<body>
    ...
    <!-- NUEVA SECCIÓN: Listado de tickets activos vendidos en la jornada actual -->
...
def home():
  ...
  # Consulta robusta para capturar solicitudes pendientes sin problemas de mayúsculas/minúsculas
  recargas_pendientes = (
