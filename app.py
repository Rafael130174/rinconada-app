    ...
    <body class="bg-light">
            ...
            <div class="container-fluid">
                ...
                <div>
                    {% if session.get('logged_in') %}
                        <a href="/admin" class="btn btn-light btn-sm me-2">Panel Admin</a>
                        <a href="/logout" class="btn btn-danger btn-sm">Salir</a>
                    {% else %}
                        <a href="/login" class="btn btn-outline-light btn-sm">Ingresar al Sistema</a>
                    {% endif %}
                </div>
            </div>
        </nav>
        <div class="container mt-4">
            <div class="card shadow-sm p-4 text-center mb-4 bg-white">
                ...
                <h1 class="display-4 fw-bold text-dark">$%.2f</h1>
            </div>
